...
; Section : 3189
; TA : Madison Emas
; Created: 2/1/2016 6:27:26 AM
;Description:
;This program reads each pin on the Keypad and returns a hex value into R16. (No key = 0xFF)
; R16 is then output on the the LED array
...
LOOP:		
	...
	ldi R17, 0xFF
	sts PORTE_DIRSET, R17		; set data direction 
	sts PORTE_OUT, R16			; output R16 in the LED ARRAY
	rjmp LOOP
